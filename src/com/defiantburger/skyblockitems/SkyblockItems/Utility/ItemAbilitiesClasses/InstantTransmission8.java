...
public class InstantTransmission8 extends ItemAbility {

    public InstantTransmission8(String name, List<String> description, String activator, List<String> activator_ids, String id) {
    ...
    public void activate(Player player) {
        ...
        try {
            b = player.getTargetBlock(transparent, 8);
