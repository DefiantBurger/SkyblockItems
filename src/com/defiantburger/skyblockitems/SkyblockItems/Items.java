...
public class Items {
    ...
    public static void initialize() {
        ...
        items.put("COW_TELEPORTER", new SkyblockItem("Cow Teleporter", Material.COW_SPAWN_EGG, 1, "COW_TELEPORTER", ItemRarities.MYTHIC, ItemTypes.CHESTPLATE, new ItemAbility[]{ItemAbilities.INSTANT_TRANSMISSION_1}));
    }
